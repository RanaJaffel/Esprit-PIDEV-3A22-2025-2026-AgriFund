...
public class RisqueListController {
    ...
    private void handleNewEvaluation() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/agrifund/fxml/Risque.fxml"));
    ...
    private void handleViewDecisionList() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/agrifund/fxml/DecisionList.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
