...
public class DecisionListController {
    ...
    private void handleNewDecision() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/agrifund/fxml/Decesion.fxml"));
    ...
    private void handleViewRisqueList() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/agrifund/fxml/RisqueList.fxml"));
            Parent root = loader.load();
