...
public class BanqueRisqueController {
    ...
    private void setupComboBoxes() {
        ...
        cbRecommandation.getItems().addAll(
                ...
                "Je recommande ce projet avec surveillance",
                "Je ne recommande pas ce projet",
                "Aucune"
        );
    }
    ...
    public void loadEvaluation(int idEvaluation) {
        try {
            ...
            if (evaluationEnCours != null) {
                ...
                cbRecommandation.setValue(getRecommandationString(evaluationEnCours.getRecommandation()));
    ...
    private String getRecommandationString(int r) {
        switch (r) {
            case 0: return "Je recommande ce projet";
            case 1: return "Je recommande ce projet avec surveillance";
            case 2: return "Je ne recommande pas ce projet";
