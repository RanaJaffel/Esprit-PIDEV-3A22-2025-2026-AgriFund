...
public class ressourceprojectmodifycontroller implements Initializable {
    ...
    void handleSave(ActionEvent event) {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Succ̬s", "Ressource modifi̩e avec succ̬s!");
            closeWindow();
        } catch (SQLException e) {
    ...
    private boolean validateInputs() {
        ...
        if (dpDateAjout.getValue().isBefore(java.time.LocalDate.now())) {
            showAlert(Alert.AlertType.ERROR, "Erreur de validation", "La date d'ajout ne peut pas ̻tre dans le pass̩!");
            return false;
        }
