...
public class AdminMessagerieController {
    ...
    private void loadConversations() throws SQLException {
        ...
        if (conversations.isEmpty()) {
            ...
            empty.setStyle("-fx-text-fill: #848A86; -fx-padding: 20;");
    ...
    public void attachFile() {
        ...
        if (file != null) {
            try {
                ...
                if (msg != null) {
                    String type = Utils.MessagerieFileManager.determinerTypeFichier(fileName);
                    ...
                    switch (type) {
                        ...
                        case "document":
                            ...
                            break;
                        case "audio":
                            storedPath = Utils.MessagerieFileManager.uploadAudio(file.getAbsolutePath(), msg.getId());
                            break;
                        default:
                            storedPath = Utils.MessagerieFileManager.uploadDocument(file.getAbsolutePath(), msg.getId());
                    }
                ...
                showAlert("Erreur lors de l'envoi: " + e.getMessage(), Alert.AlertType.ERROR);
            }
        }
    }
        ...
        try {
            ...
            for (Utilisateur u : users) {
                if (u.getId() != currentUserId) {
                    dialog.getItems().add(u.getId() + " - " + u.getPrenom() + " " + u.getNom());
                }
            }
