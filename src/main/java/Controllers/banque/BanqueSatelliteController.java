...
import Components.GoogleMapView;
import Controllers.MainApp;
import Services.BanqueService;
import Services.NasaEarthDataService;
import Services.PdfExportService;
import Utils.SessionManager;
import entities.AnalyseRisqueAgricole;
import entities.Banque;
import entities.DonneesSatellite;
...
public class BanqueSatelliteController {
    ...
    public void goToDashboard() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/banque/banque-dashboard.fxml"));
