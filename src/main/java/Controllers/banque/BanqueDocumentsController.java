...
public class BanqueDocumentsController {
    ...
    private VBox createDocumentCard(Document doc) {
        ...
        typeLabel.setStyle("-fx-text-fill: #E1B323;");
        ...
        details.getChildren().add(sizeLabel);
    ...
    private String formatDocType(String type) {
        switch (type.toLowerCase()) {
            case "kbis": return "KBIS / Registre du Commerce";
            case "agrement": return "Agrément Bancaire";
            case "licence": return "Licence d'exploitation";
            case "statuts": return "Statuts de la société";
            default: return type;
        }
    }
    ...
    public void showAddDocumentDialog() {
        ...
        dialog.setHeaderText("Télécharger un document officiel");
        ...
        typeCombo.setItems(FXCollections.observableArrayList(
                "KBIS", "Agrément", "Licence", "Statuts", "Autre"
        ));
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == uploadButtonType) {
                ...
                try {
                    String typeDoc = typeCombo.getValue().toLowerCase();
                    ...
                    if (storedPath != null) {
                        ...
                        showAlert("Document ajouté avec succès!", Alert.AlertType.INFORMATION);
                    }
    ...
    private void openDocument(Document doc) {
        try {
            ...
            if (file.exists()) {
                ...
                showAlert("Fichier introuvable", Alert.AlertType.WARNING);
            }
        } catch (IOException e) {
    ...
    @FXML public void filterAll() { currentFilter = "all"; updateFilterButtons(); applyFilter(); }
    @FXML public void filterValidated() { currentFilter = "validated"; updateFilterButtons(); applyFilter(); }
    @FXML public void filterPending() { currentFilter = "pending"; updateFilterButtons(); applyFilter(); }
    @FXML public void filterRejected() { currentFilter = "rejected"; updateFilterButtons(); applyFilter(); }

    private void updateFilterButtons() {
        btnAll.setStyle(currentFilter.equals("all") ? "-fx-background-color: #E1B323; -fx-text-fill: #060806;" : "");
